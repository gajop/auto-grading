...
#            pass #oh well
    ...
    return render(request,
                  ...
                  {'course_sessions': course_sessions, 'menu':mainMenu()} )
...
def read(request, id):
    ...
    return render(request,
                  ...
                  {'course_session': course_session, 'menu':mainMenu()})
...
def update(request, id):
    ...
    return render(request, 
                  ...
                  {'CourseSession' : course_session, 'form': form, 'menu':mainMenu()} )
